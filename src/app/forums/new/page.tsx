...
export default function NewDiscussionPage() {
    ...
    useEffect(() => {
        if (!authLoading && !user) {
            router.push('/auth?redirect=/forums/new');
        }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push(`/forums/${result.data._id}`);
        } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-black pt-16">
            ...
            <div className="max-w-3xl mx-auto px-4 py-8">
                <h1 className="text-2xl font-bold text-white mb-2">Start a Discussion</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <MarkdownEditor
                            value={content}
                            onChange={setContent}
                            placeholder="Describe your question or topic in detail. Use markdown for formatting and code blocks."
                            minHeight={250}
                            maxLength={10000}
